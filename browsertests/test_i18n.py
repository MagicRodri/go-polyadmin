...
# widgets/table.html renders row cells raw -- see donut.html and
# timeline.html). App chrome goes through {{t}} instead, which the pseudo
# locale brackets, and the sweep below strips bracketed text before
# checking, so none of that needs listing here.
#
