...
def test_the_date_filter_narrows_the_list(admin_page):
    ...
    # Go leaves the filter key's brackets literal in list URLs; the Python
    # suite's copy expects them percent-encoded.
    expect(admin_page).to_have_url(re.compile(r"filter\[Founded\]=year"))
